...
\begin{publications}
  ...
  % 已添加成果条目，按模板从 pub.bib 渲染。
  \addpubs{zhang2026manage,zhu2025flvehpatent,zhu2025dqnvehpatent}
  ...
  \pubsection{申请专利}
  \printbibliography[heading=none,type=patent,category=mypub,resetnumbers=true]

  \pubsection{参与的科研项目}
  \zihao{5}
  \renewcommand{\labelenumi}{[\theenumi]}
  \begin{enumerate}[nosep, leftmargin=4ex-2pt, labelsep=1ex]
    \item 基层社区治理—感多识监测预警技术装备研究与应用示范. 国家重点研发计划项目. 2024.12--2027.11
    \item 天基网络分布式试验智能管控与数据分析技术研究. 中国卫星网络应用研究院企业横向合作项目. 2024.4--2025.11
  \end{enumerate}
